...
use crate::bitcoin::BitcoinContext;
use bitcoin::{
...
/// Builds a transaction skeleton and prevouts to be signed for fee iteration.
...
///
/// Only P2PKH is retained because current services only generate legacy addresses.
pub enum Purpose {
    P2PKH, // BIP-44
}
...
///
/// This implementation supports the subset needed by current services.
pub struct DerivationPath {
    /// Purpose according to BIP-43 (e.g., 44 for legacy)
    purpose: Purpose,
